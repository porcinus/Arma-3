...
switch _mode do
{
	...
	case "Initialize":
	{
		...
		if (!isNull _camera) then
		{
			...
			// Create dummy target
			missionNamespace setVariable [VAR_CAMERA_DUMMY_TARGET, "Logic" createVehicleLocal getPosASLVisual player];
	...
	case "Terminate":
	{
		...
		// Stop ticking
		removeMissionEventHandler ["EachFrame", missionNamespace getVariable [VAR_CAMERA_TICK, -1]];
