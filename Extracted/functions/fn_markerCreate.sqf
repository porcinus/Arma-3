					...
					switch (count _param) do {
						...
						case 1: {
							if (_markerSize distance [0,0] == 0) then {
								...
								_markerSizeXY = _param param [0,1,[0]];
						...
						case 2: {
							if (_markerSize distance [0,0] == 0) then {
								...
								_markerSizeX = _param param [0,1,[0]];
								_markerSizeY = _param param [1,1,[0]];
						...
						case 3: {
							if (_markerPos distance [0,0,0] == 0) then {
								...
								_markerPosX = _param param [0,1,[0]];
								_markerPosY = _param param [1,1,[0]];
