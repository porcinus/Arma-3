...
_sides = _this param [0,missionnamespace getvariable ["bis_fnc_bleedTickets_sides",[east,west,resistance]],[[]]];
_ticketBleedRatio = _this param [1,missionnamespace getvariable ["bis_fnc_bleedTickets_ticketBleedRatio",0.5],[0]];
_ticketBleedMax = _this param [2,missionnamespace getvariable ["bis_fnc_bleedTickets_ticketBleedMax",3],[0]];
_delay = _this param [3,5,[0]];
