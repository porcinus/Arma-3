...
Example: _null = tower1 call BIS_fnc_NNS_Populate_CargoTower_More;;
...
// Check for validity
if (isNull _tower) exitWith {[format["BIS_fnc_NNS_Populate_CargoTower_More : Non-existing unit tower %1 used!",_tower]] call BIS_fnc_NNS_debugOutput;};

[format["BIS_fnc_NNS_Populate_CargoTower_More : %1",player distance2d _tower]] call BIS_fnc_NNS_debugOutput; //debug
