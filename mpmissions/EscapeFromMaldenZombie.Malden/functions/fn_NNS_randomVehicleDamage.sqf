...
Work in parallel with BIS_fnc_NNS_setAllHitPointsDamage via remoteExec.
...
if (count _vehiHit == 0) exitWith {[format["BIS_fnc_NNS_randomVehicleDamage : %1 : No hitpoint detected",_vehicle]] call BIS_fnc_NNS_debugOutput;};
...
//[_vehicle,_vehiHitNew] remoteExec ["BIS_fnc_NNS_setAllHitPointsDamage"];
