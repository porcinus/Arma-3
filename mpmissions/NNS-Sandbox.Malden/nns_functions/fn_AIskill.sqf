...
Example: 
_skill = [aiunit] call NNS_fnc_AIskill;
_skill = [aiunit,"sniper"] call NNS_fnc_AIskill;
...
// Check for validity
if (isNull _unit) exitWith {[format["NNS_fnc_AIskill : Non-existing unit %1 used!",_unit]] call NNS_fnc_debugOutput;};
...
//[format["NNS_fnc_AIskill : _AIskill:%1, _modifier:%2, _AInewSkill:%3",_unit]] call NNS_fnc_debugOutput;
