if !(["objective2"] call BIS_fnc_taskExists) then {
	...
	[BIS_grpMain,["objective2","objEscape"],[localize "STR_NNS_Escape_Objective_Checkpoint_desc",localize "STR_NNS_Escape_Objective_EastCheckpoint_title",""],getMarkerPos "NNS_checkpoint_marker_02","ASSIGNED",1,true,"attack"] call BIS_fnc_taskCreate;
