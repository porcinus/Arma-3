...
while {missionNamespace getVariable ["DebugCountUnitsLoop",true]} do {
	...
	_output = ["Current units count:"];
	_output pushBack format["west: %1 ,alive: %2 ,active: %3",_west_count,_west_alive_count,_west_active_count];
	_output pushBack format["east: %1 ,alive: %2 ,active: %3",_east_count,_east_alive_count,_east_active_count];
	_output pushBack format["resistance: %1 ,alive: %2 ,active: %3",_resistance_count,_resistance_alive_count,_resistance_active_count];
