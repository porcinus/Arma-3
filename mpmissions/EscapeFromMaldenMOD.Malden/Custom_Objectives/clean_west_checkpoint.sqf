if !(["objective5"] call BIS_fnc_taskExists) then {
	...
	[BIS_grpMain,["objective5","objEscape"],[localize "STR_NNS_Objective_Checkpoint_desc",localize "STR_NNS_Objective_WestCheckpoint_title",""],getMarkerPos "NNS_checkpoint_marker_03","ASSIGNED",1,true,"attack"] call BIS_fnc_taskCreate;
