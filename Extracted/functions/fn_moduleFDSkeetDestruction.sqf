...
_pos = _this param [0, [10, 10, 10], [[]]];
_vel = _this param [1, [0, 0, 0], [[]]];
_color = _this param [2, "", [""]];
...
if (_color != "") then 
{
	switch (toLower _color) do  
	{
		...
		case "purple": {_colorArray = [0.69,0.251,0.655];};
		case "white": {_colorArray = [0.8,0.8,0.8];};
		case "purple": {_colorArray = [0.690,0.251,0.655];};
	};
};
_colorPostfix = "";
