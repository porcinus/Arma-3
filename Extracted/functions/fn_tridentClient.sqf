...
_logic = _this param [1,objnull,[objnull]];
_sideA = _this param [2,sideUnknown,[sideUnknown]];
_sideB = _this param [3,sideUnknown,[sideUnknown]];
_curator = _this param [4,objnull,[objnull]];
_showNotification = _this param [5,true,[true]];
