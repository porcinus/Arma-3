...
/*
	...
	Example:
	_structuredText = _unit call bis_fnc_reviveGet3dIcons;
*/

private _selected = if (group player != group _unit) then
{
	if (bis_revive_timer == 0 || {isNil{_this getVariable "bis_fnc_reviveGet3dIcons_textures"}}) then
	{
		switch (true) do
		{
			case (!alive _this):
			...
			{
				[TEXTURES_3D_DYING,TEXTURES_3D_UNCONSCIOUS] select bis_revive_timerCounter2
			};
			case ((_this getVariable [VAR_BLOOD_LEVEL,3]) == 2):
			{
				[TEXTURES_3D_DYING,TEXTURES_3D_UNCONSCIOUS,TEXTURES_3D_UNCONSCIOUS] select bis_revive_timerCounter3
			};
			default
			{
	...
	else
	{
		...
		{
			_this getVariable "bis_fnc_reviveGet3dIcons_textures";
		};
	};
}
else
{
	if (bis_revive_timer == 0 || {isNil{_this getVariable "bis_fnc_reviveGet3dIcons_textures"}}) then
	{
		switch (true) do
		{
			...
			case ((_this getVariable [VAR_BLOOD_LEVEL,3]) == 1):
			{
				[TEXTURES_3D_GROUP_DYING,TEXTURES_3D_GROUP_UNCONSCIOUS] select bis_revive_timerCounter2
			};
			case ((_this getVariable [VAR_BLOOD_LEVEL,3]) == 2):
			{
				[TEXTURES_3D_GROUP_DYING,TEXTURES_3D_GROUP_UNCONSCIOUS,TEXTURES_3D_GROUP_UNCONSCIOUS] select bis_revive_timerCounter3
			};
			default
			{
...
_this setVariable ["bis_fnc_reviveGet3dIcons_textures",_selected];
