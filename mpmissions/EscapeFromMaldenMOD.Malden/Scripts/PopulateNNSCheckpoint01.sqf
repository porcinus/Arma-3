...
_null = checkpoint_01_hq_0 call NNS_fnc_Populate_CargoHQ;
_null = checkpoint_01_bunker_0 call NNS_fnc_Populate_BagBunkerTower;
_null = checkpoint_01_bunker_1 call NNS_fnc_Populate_BagBunkerTower;
