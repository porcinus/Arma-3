...
_null = houdan_tower_0 call NNS_fnc_CargoTower_Equipments;

//NNS: Init zombie spawner
if (houdan_zombie_0 getVariable ["TotalAmount",-1] != -1) then {
	[] spawn {[houdan_zombie_0] call RyanZM_fnc_rzfunctionspawn;};
};
