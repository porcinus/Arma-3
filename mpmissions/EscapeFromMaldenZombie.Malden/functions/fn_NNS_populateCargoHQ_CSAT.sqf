...
Example: _null = cargohq1 call BIS_fnc_NNS_populateCargoHQ_CSAT;
*/
...
// Check for validity
if (isNull _building) exitWith {[format["BIS_fnc_NNS_populateCargoHQ_CSAT : Non-existing unit cargohq %1 used!",_building]] call BIS_fnc_NNS_debugOutput; []};
if !(alive _building) exitWith {["BIS_fnc_NNS_populateCargoHQ_CSAT : HQ is destroyed!"] call BIS_fnc_NNS_debugOutput; []};

[format["BIS_fnc_NNS_populateCargoHQ_CSAT : %1",player distance2d _building]] call BIS_fnc_NNS_debugOutput; //debug
