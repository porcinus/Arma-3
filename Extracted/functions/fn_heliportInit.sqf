...
//--- Custom variables
_allowAmbientLife = (_logic getvariable "allowAmbientLife") param [0,true,[true]];
_allowSetDate = (_logic getvariable "allowSetDate") param [0,true,[true]];
...
//--- Identities
#include "fn_heliportInitPersons.inc"
...
//--- Radio channels
#include "fn_heliportInitRadio.inc"
