...
Example: _null = tower1 call NNS_fnc_populateTower_Nato;
...
// Check for validity
if (isNull _tower) exitWith {[format["NNS_fnc_populateTower_Nato : Non-existing unit tower %1 used!",_tower]] call NNS_fnc_debugOutput; []};
if (damage _tower > 0.99) exitWith {["NNS_fnc_populateTower_Nato : Tower is almost destroyed!"] call NNS_fnc_debugOutput; []};

[format["NNS_fnc_populateTower_Nato : %1",player distance2d _tower]] call NNS_fnc_debugOutput; //debug

_classesNATO = ["B_Soldier_SL_F","B_soldier_M_F","B_soldier_AR_F","B_soldier_GL_F","B_soldier_F","B_engineer_F","B_medic_F","B_HeavyGunner_F"];
...
_unit01a = _grp01 createUnit [selectRandom _classesNATO, [0,0,0], [], 0, "CAN_COLLIDE"]; _unit01a setPosASL _pos01a;
_unit01b = _grp01 createUnit [selectRandom _classesNATO, [0,0,0], [], 0, "CAN_COLLIDE"]; _unit01b setPosASL _pos01b;
...
_unit02a = _grp02 createUnit [selectRandom _classesNATO, [0,0,0], [], 0, "CAN_COLLIDE"]; _unit02a setPosASL _pos02a;
_unit02b = _grp02 createUnit [selectRandom _classesNATO, [0,0,0], [], 0, "CAN_COLLIDE"]; _unit02b setPosASL _pos02b;
...
_unit03a = _grp03 createUnit [selectRandom _classesNATO, [0,0,0], [], 0, "CAN_COLLIDE"]; _unit03a setPosASL _pos03a;
_unit03b = _grp03 createUnit [selectRandom _classesNATO, [0,0,0], [], 0, "CAN_COLLIDE"]; _unit03b setPosASL _pos03b;
...
_unit04a = _grp04 createUnit [selectRandom _classesNATO, [0,0,0], [], 0, "CAN_COLLIDE"]; _unit04a setPosASL _pos04a;
_unit04b = _grp04 createUnit [selectRandom _classesNATO, [0,0,0], [], 0, "CAN_COLLIDE"]; _unit04b setPosASL _pos04b;
