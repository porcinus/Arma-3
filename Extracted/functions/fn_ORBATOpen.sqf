...
//--- Make sure it's executed in missionNamespace, as it's declaring global variables there
if !(currentnamespace isequalto missionnamespace) exitwith {
	with missionnamespace do {_this call bis_fnc_ORBATOpen;};
};
...
_parentDisplay = _this param [1,_parentDisplayDefault,[displaynull]];
_tags = _this param [2,[],[[]]];
_deepnessLimit = _this param [3,-1,[0]];
_onClick = _this param [4,[],[[]]];
