...
_commit = _this param [1,1,[0]];
_display = _this param [2,finddisplay 506,[displaynull]];
_icons = _this param [3,missionnamespace getvariable ["BIS_fnc_strategicMapOpen_ORBAT",[]],[[]]];
