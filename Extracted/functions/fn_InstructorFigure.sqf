...
_AddTopic = 
{
	...
	_array = _this param [0,[],[[]]];
	_tmptopic = _array param [0,"",[""]];
	_tmpcontainer = _array param [1,missionname,[""]];
	_tmpconvname = _array param [2,missionname,[""]];
	_tmpchannel = _array param [3,"",[""]];
	...
	if !(player diarySubjectExists "Instructor") then 
	{
...
_PlayCore = 
{
	...
	_tmptopic = _this param [0,0,[0]];
	_tmpfigure = _this param [1,0,[0]];
