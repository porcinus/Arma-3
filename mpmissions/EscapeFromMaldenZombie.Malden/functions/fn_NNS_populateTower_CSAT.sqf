...
Example: _null = tower1 call BIS_fnc_NNS_populateTower_CSAT;
...
// Check for validity
if (isNull _tower) exitWith {[format["BIS_fnc_NNS_populateTower_CSAT : Non-existing unit tower %1 used!",_tower]] call BIS_fnc_NNS_debugOutput; []};
if !(alive _tower) exitWith {["BIS_fnc_NNS_populateCargoHQ_CSAT : Tower is destroyed!"] call BIS_fnc_NNS_debugOutput; []};

[format["BIS_fnc_NNS_populateTower_CSAT : %1",player distance2d _tower]] call BIS_fnc_NNS_debugOutput; //debug
...
} forEach [_unit01a,_unit01b,_unit02a,_unit02b,_unit03a,_unit03b,_unit04a,_unit04b];
...
[_unit01a,_unit01b,_unit02a,_unit02b,_unit03a,_unit03b,_unit04a,_unit04b]