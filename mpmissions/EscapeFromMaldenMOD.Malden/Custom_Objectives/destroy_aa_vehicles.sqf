if !(["objective9"] call BIS_fnc_taskExists) then {
	...
	[BIS_grpMain,["objective9","objEscape"],[localize "STR_NNS_Escape_Objective_AAvehicles_desc",localize "STR_NNS_Escape_Objective_AAvehicles_title",""],getMarkerPos "objective_zone_9","ASSIGNED",1,true,"destroy"] call BIS_fnc_taskCreate;
