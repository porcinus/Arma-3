if !(["objective7"] call BIS_fnc_taskExists) then {
	...
	for "_i" from 0 to 3 do { //select 4 random object and 4 random marker to reveal
		...
		[_rndObject, [localize "STR_NNS_CollectIntel_name", "scripts\Intel.sqf", ["markeralpha",_rndMarker,1]]] remoteExec ["addAction", 0, true];
	...
	[(_objects select 0), [localize "STR_NNS_CollectIntel_name", "scripts\Intel.sqf", ["execvm","scripts\RescueCSATsquad.sqf",[_hostageBarn,["rescueCSATsquad0","objEscape"],BIS_grpMain,["meetCSATsniper0","objEscape"]]]]] remoteExec ["addAction", 0, true];
	...
	[BIS_grpMain,["objective7","objEscape"],[localize "STR_NNS_Objective_Intel_desc",localize "STR_NNS_Objective_Intel_title",""],getMarkerPos "objective_zone_7","ASSIGNED",1,true,"intel"] call BIS_fnc_taskCreate;
