...
Populate guard post with 2 NATO units

Example: _null = post call NNS_fnc_populatePost_Nato;
*/
...
_unit01 = _grp01 createUnit [selectRandom ["B_Soldier_LAT_F","B_HeavyGunner_F"], [0,0,0], [], 0, "CAN_COLLIDE"]; _unit01 setPosASL _pos01;
_unit02 = _grp01 createUnit [selectRandom ["B_Sharpshooter_F","B_Soldier_M_F"], [0,0,0], [], 0, "CAN_COLLIDE"]; _unit02 setPosASL _pos02;
