...
Example: _null = cargohq1 call BIS_fnc_NNS_Populate_CargoHQ_More;
...
// Check for validity
if (isNull _building) exitWith {[format["BIS_fnc_NNS_Populate_CargoHQ_More : Non-existing unit cargohq %1 used!",_building]] call BIS_fnc_NNS_debugOutput;};

[format["BIS_fnc_NNS_Populate_CargoHQ_More : %1",player distance2d _building]] call BIS_fnc_NNS_debugOutput; //debug
