...
_fsmMode = _this param [0,"",[""]];
_fsmId = _this param [1,0,[0]];
...
/*%FSM</CONDITION>*/}): {
        ...
        case "STATE_Add_a_new_task":
        {
            ...
            _pos = _params param [0,markerpos "BIS_attack"];
            _name = _params param [1,"the location"];
            _current = _params param [2,true,[true]];
        ...
        case "STATE_Change_task_stat":
        {
            ...
            /*%FSM<STATEINIT>*/
            private ["_state"];
            _state = _params param [0,"succeeded",[""]];
