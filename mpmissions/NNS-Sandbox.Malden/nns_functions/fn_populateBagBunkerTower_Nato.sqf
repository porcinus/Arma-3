...
Example: _null = bunker1 call NNS_fnc_populateBagBunkerTower_Nato;
...
// Check for validity
if (isNull _bunker) exitWith {[format["NNS_fnc_populateBagBunkerTower_Nato : Non-existing unit bunker %1 used!",_tower]] call NNS_fnc_debugOutput;};
if (damage _bunker > 0.99) exitWith {["NNS_fnc_populateTower_Nato : Bunker is almost destroyed!"] call NNS_fnc_debugOutput; []};

[format["NNS_fnc_populateBagBunkerTower_Nato : %1",player distance2d _bunker]] call NNS_fnc_debugOutput; //debug
