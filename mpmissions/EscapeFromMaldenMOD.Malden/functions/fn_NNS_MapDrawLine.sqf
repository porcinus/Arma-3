...
Example: _null = [marker_name,old_pos,new_pos,"ColorBlack",line_width,alpha,timeout] call BIS_fnc_NNS_MapDrawLine;
...
[format["BIS_fnc_NNS_MapDrawLine : start: %1, end: %2, color: %3, width: %4, alpha: %5, timeout: %6",_pos_start,_pos_end,_color,_width,_alpha,_timeout]] call BIS_fnc_NNS_debugOutput; //debug
