...
_resizeW = _this param [2,false,[false]];
_resizeH = _this param [3,true,[false]];
...
with uinamespace do {
	...
	["GUI","GRID"] call BIS_fnc_guiGrid params ["_GUI_GRID_X", "_GUI_GRID_Y", "_GUI_GRID_WAbs", "_GUI_GRID_HAbs"];
