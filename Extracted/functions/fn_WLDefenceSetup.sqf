...
waitUntil {BIS_WL_spacePressed || BIS_WL_backspacePressed || (position _def) # 2 > 300 || vehicle player != player || !alive player || lifeState player == "INCAPACITATED" || triggerActivated BIS_WL_enemiesCheckTrigger};
