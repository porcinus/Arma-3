if !(["objective1"] call BIS_fnc_taskExists) then {
	...
	[BIS_grpMain,["objective1","objEscape"],[localize "STR_NNS_Escape_Objective_Checkpoint_desc",localize "STR_NNS_Escape_Objective_SouthCheckpoint_title",""],getMarkerPos "NNS_checkpoint_marker_01","ASSIGNED",1,true,"attack"] call BIS_fnc_taskCreate;
