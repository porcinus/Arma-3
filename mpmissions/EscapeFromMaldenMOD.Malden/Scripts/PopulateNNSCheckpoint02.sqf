...
_null = checkpoint_02_hq_0 call NNS_fnc_Populate_CargoHQ;
_null = checkpoint_02_bunker_0 call NNS_fnc_Populate_BagBunkerTower;
_null = checkpoint_02_bunker_1 call NNS_fnc_Populate_BagBunkerTower;
