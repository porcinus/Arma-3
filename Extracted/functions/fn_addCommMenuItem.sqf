...
_argsText = _this param [2,[]];
_argsExpression = _this param [3,[]];
_notificationClass = _this param [4,"CommunicationMenuItemAdded",[""]];
...
if (isnil {BIS_fnc_addCommMenuItem_load}) then
{
	...
	{
		[] spawn {sleep 1;[] call bis_fnc_refreshCommMenu;};
	}];
};
