...
Example: _null = cargohq1 call NNS_fnc_Populate_CargoHQ;
...
// Check for validity
if (isNull _building) exitWith {[format["NNS_fnc_Populate_CargoHQ : Non-existing unit cargohq %1 used!",_building]] call NNS_fnc_debugOutput;};

[format["NNS_fnc_Populate_CargoHQ : %1",player distance2d _building]] call NNS_fnc_debugOutput; //debug
