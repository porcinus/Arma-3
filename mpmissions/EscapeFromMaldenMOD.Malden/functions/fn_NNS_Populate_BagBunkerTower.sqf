...
Example: _null = bunker1 call BIS_fnc_NNS_Populate_BagBunkerTower;
...
// Check for validity
if (isNull _tower) exitWith {[format["BIS_fnc_NNS_Populate_BagBunkerTower : Non-existing unit tower %1 used!",_tower]] call BIS_fnc_NNS_debugOutput;};

[format["BIS_fnc_NNS_Populate_BagBunkerTower : %1",player distance2d _bunker]] call BIS_fnc_NNS_debugOutput; //debug
